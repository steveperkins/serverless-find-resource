...
1. Run `npm i @steveperkins/serverless-find-resource@1.0.0 --save-dev`. Of course you also need Serverless to be installed because this is a Serverless plugin.
